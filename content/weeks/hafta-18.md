...
tags:
  ...
  - "okuryazarlık"
objectives:
  - "Başlıca üretken YZ araçlarını özellikleri ile karşılaştırır."
...
- Ders notlarını özetletme ve kendinize soru ürettirme.
- Bir makalenin yöntem bölümünü sade Türkçeyle açıklatma.

## Uygulama / Etkinlik

Bir ders konusunu üç farklı araçla özetletin; hangisinin daha doğru ve yararlı olduğunu ölçütlerle değerlendirin.

## Tartışma Soruları

1. Hangi görevleri asla tek başına bir YZ aracına bırakmazsınız?

## Haftanın Özeti

Üretken YZ araçlarını tanıdık ve eleştirel kullanımın temel alışkanlıklarını edindik.
